...
{
    public partial class mig_initial_create_tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOldPrice = table.Column<double>(type: "float", nullable: false),
                    ItemDiscount = table.Column<double>(type: "float", nullable: false),
                    ItemAdType = table.Column<int>(type: "int", nullable: false),
                    ItemAnnouncementDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BrandID = table.Column<int>(type: "int", nullable: false),
                    gGuarantee = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemShowcaseImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemSubShowcaseImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemDetailID = table.Column<int>(type: "int", nullable: false),
                    SubCategoryID = table.Column<int>(type: "int", nullable: false),
                    ItemImageID = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
